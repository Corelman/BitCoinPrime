...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bitcoinprime " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bitcoinprimetools.com", "dnsseed.bitcoinprimetools.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"bitcoinprimetools.com", "testnet-seed.bitcoinprimetools.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bitcoinprime is probably already running."), addrBind.ToString().c_str());
        else
